...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 27, 2022 at 07:49 AM
...
--
-- Table structure for table `tbl_students_0556`
--

CREATE TABLE `tbl_students_0556` (
  `id` int(55) NOT NULL,
...
--
-- Dumping data for table `tbl_students_0556`
--

INSERT INTO `tbl_students_0556` (`id`, `nim`, `nama`, `jk`, `jurusan`, `alamat`) VALUES
...
--
-- Indexes for table `tbl_students_0556`
--
ALTER TABLE `tbl_students_0556`
  ADD PRIMARY KEY (`id`);
COMMIT;
